...
export default async function ProPage() {
  ...
  return (
    <div className="max-w-7xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Pro Features</h1>
      ...
      <div className="space-y-6">
        ...
        {/* Upgrade Notice */}
        <div className="rounded-lg bg-nebula-50 dark:bg-nebula-900/20 border border-nebula-200 dark:border-nebula-800 p-6">
          <h3 className="text-lg font-semibold text-nebula-900 dark:text-nebula-100 mb-2">
            Want even more?
          </h3>
          <p className="text-sm text-nebula-800 dark:text-nebula-200 mb-4">
